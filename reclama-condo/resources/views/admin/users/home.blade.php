            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="table-responsive mt-4">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal" data-user-id="{{ $user->id }}">
                                            Delete
                                        </button>
                                    </td>
                                </tr>
                        ...
                        <h4 class="mt-4">Total Users: {{ $users->count() }}</h4>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            deleteModal.addEventListener('show.bs.modal', function(event) {
                ...
                deleteForm.setAttribute('action', `/admin/dashboard/users/${userId}`);
            });
        });
    </script>
</x-app-layout>